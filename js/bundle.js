...
var signingup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(role, username, email, phone, password, confirmpassword) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
  ...
  return function signingup(_x, _x2, _x3, _x4, _x5, _x6) {
    return _ref.apply(this, arguments);
  };
}();

exports.signingup = signingup;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"newRoom.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.addingRoom = void 0;
...
var addingRoom = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, address, BHK, city, state, pin, price, imageCover, image, summary, description) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'New room added successfully');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
  ...
  return function addingRoom(_x, _x2, _x3, _x4, _x5, _x6, _x7, _x8, _x9, _x10, _x11) {
    return _ref.apply(this, arguments);
  };
}();

exports.addingRoom = addingRoom;
...
exports.updateSettings = exports.updateRoomData = void 0;
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://localhost:3000/api/v1/user/updatePassword' : 'http://localhost:3000/api/v1/user/updateMe';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
var updateRoomData = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(name, address, BHK, city, state, pin, price, imageCover, image, summary, description) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://localhost:3000/api/v1/room/".concat(room.id),
              data: {
                name: name,
                address: address,
                BHK: BHK,
  ...
  return function updateRoomData(_x3, _x4, _x5, _x6, _x7, _x8, _x9, _x10, _x11, _x12, _x13) {
    return _ref2.apply(this, arguments);
  };
}();
...
var stripe = Stripe("pk_test_51Kx4xISIKmq28W4GNhB8NgixedlKf871yVkRFdQsxT3MRgBrJcGBalLheDbBCbuyxqbxh72tBZ63xAIS5aB0ZnTw00Y5wcslRD");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://localhost:3000/api/v1/bookings/checkout-session/".concat(roomId));

          case 3:
            session = _context.sent;
            console.log(session); //2.create checkour form
...
var updateRoomForm = document.querySelector('.form--updateRoom');
var createNewRoom = document.querySelector('.form--newRoom');
var bookBtn = document.getElementById('book-room');
if (loginFrom) loginFrom.addEventListener('submit', function (e) {
  //e is event which is a callback function
  e.preventDefault();
...
if (signupFrom) signupFrom.addEventListener('submit', function (e) {
  ...
  (0, _signup.signingup)(role, username, email, phone, password, confirmpassword);
});
...
if (updateDataForm) updateDataForm.addEventListener('submit', function (e) {
  ...
  var email = document.getElementById('email').value;
  var phone = document.getElementById('phone').value;
  var photo = document.getElementById('photo').value; // updateData(username,email,phone)
...
if (createNewRoom) createNewRoom.addEventListener('submit', /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(e) {
    var name, address, BHK, city, state, pin, price, imageCover, image, summary, description;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            imageCover = document.getElementById('coverImg').value;
            image = document.getElementById('imgs').value;
            summary = document.getElementById('summary').value;
            description = document.getElementById('description').value;
            (0, _newRoom.addingRoom)(name, address, BHK, city, state, pin, price, imageCover, image, summary, description);
